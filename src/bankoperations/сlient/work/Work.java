...
public class Work {
    ...
    public boolean equals(Object object) {
        ...
        return salary == work.getSalary() &&
                (companyName == work.getCompanyName() || (companyName != null && companyName.equals(work.getCompanyName()))) &&
                (positionName == work.getPositionName() || (positionName != null && positionName.equals(work.getPositionName()))) &&
                (moneyType == work.getMoneyType() || (moneyType != null && moneyType.equals(work.getMoneyType())));
    }
